 ...
 */
UCLASS()
class HOTSAUCE_API AHSPlayerState : public APlayerState
{
	GENERATED_BODY()

public:

    AHSPlayerState(const FObjectInitializer& ObjectInitializer);
    ...
    */
    ...
    void ScoreKill(AHSPlayerState* Victim, int32 Points);

    /** player died */
    void ScoreDeath(AHSPlayerState* KilledBy, int32 Points);
    ...
    void InformAboutKill(class AHSPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class AHSPlayerState* KilledPlayerState);

    /** broadcast death to local clients */
    UFUNCTION(Reliable, NetMulticast)
    void BroadcastDeath(class AHSPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class AHSPlayerState* KilledPlayerState);
